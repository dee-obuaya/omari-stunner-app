...
export default function ThemeToggle() {
    ...
    return (
        <div className='flex w-max justify-self-end p-3'>
            <label className="swap swap-rotate">
                {/* this hidden checkbox controls the state */}
                <input type="checkbox" className="theme-controller" value="synthwave" checked={theme === 'omari-dark'} onChange={handleToggle}/>
